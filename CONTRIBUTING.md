...
* [Contributing](#contributing)
  ...
  * [Common fixes for `mypy` errors](#common-fixes-for-mypy-errors)
    * [`if typing.TYPE_CHECKING:` usage](#if-typingtype_checking-usage)
...
1. Select the right group file in `src/databricks/labs/pytester/fixtures/`
2. Add fixture with extensive usage documentation in the docstring.
3. Import the fixture in `src/databricks/labs/pytester/fixtures/plugin.py` and export it via `__all__` list.
4. Run `make fmt` to regenerate [README.md](README.md) with the updated fixtures.
5. Update Table of Contents in [README.md](README.md) with the new fixture.
